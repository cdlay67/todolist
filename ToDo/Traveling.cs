...
namespace ToDo
{
    public partial class Traveling : UserControl
    {
        public Traveling()
        {
            InitializeComponent();
        ...
        void getToDolist()
        {
            ...
            {
                SQL.Open();
                SqlCommand command = new SqlCommand("SELECT * FROM Traveling", SQL);
        ...
        public void addToDolist(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandSec = new SqlCommand("INSERT INTO Traveling (listtext) VALUES ('" + insert + "')", SQL);
        ...
        public void saveToDolist(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandSec = new SqlCommand("INSERT INTO Complete (Traveltext) VALUES ('" + insert + "')", SQL);
                commandSec.ExecuteNonQuery();
            }
        }
