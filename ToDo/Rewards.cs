...
namespace ToDo
{
    public partial class Rewards : UserControl
    {
        ...
        void getToDolist()
        {
            ...
            {
                SQL.Open();
                SqlCommand command = new SqlCommand("SELECT * FROM Rewards", SQL);
        ...
        public void addToDolist(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandSec = new SqlCommand("INSERT INTO Rewards (listtext) VALUES ('" + insert + "')", SQL);
        ...
        public void saveToDolist(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandSec = new SqlCommand("INSERT INTO Complete (Rewardtext) VALUES ('" + insert + "')", SQL);
                commandSec.ExecuteNonQuery();
            }
        }
