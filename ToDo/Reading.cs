...
namespace ToDo
{
    public partial class Reading : UserControl
    {
        ...
        void getToDolist()
        {
            ...
            {
                SQL.Open();
                SqlCommand command = new SqlCommand("SELECT * FROM Reading", SQL);
        ...
        public void addToDolist(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandSec = new SqlCommand("INSERT INTO Reading (listtext) VALUES ('" + insert + "')", SQL);
        ...
        public void saveToDolist(string insert)
        {
            ...
            {
                SQL.Open();
                SqlCommand commandSec = new SqlCommand("INSERT INTO Complete (Readtext) VALUES ('" + insert + "')", SQL);
                commandSec.ExecuteNonQuery();
            }
        }
